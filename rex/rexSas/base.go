...
// @doc "预签名访问"
func (m *defaultBaseService) PresignerGet(ctx context.Context, params *rexTypes.SasPresignerGetObjectReq) (result *rexTypes.SasPresignerGetObjectResp, err error) {
...
func (m *defaultBaseService) QueryBucket(ctx context.Context, params *rexTypes.SasQueryBucketReq) (result *rexTypes.SasQueryBucketResp, err error) {
...
func (m *defaultBaseService) PresignerUpload(ctx context.Context, params *rexTypes.SasPresignerUploadReq) (result *rexTypes.SasPresignerUploadResp, err error) {
...
func (m *defaultBaseService) PresignerHeadObject(ctx context.Context, params *rexTypes.SasPresignerHeadObjectReq) (result *rexTypes.SasPresignerHeadObjectResp, err error) {
...
func (m *defaultBaseService) CreateBucketAndConfig(ctx context.Context, params *rexTypes.CreateExistBucketAndConfigReq) (result *rexTypes.CreateExistBucketAndConfigResp, err error) {
...
func (m *defaultBaseService) CreateBucketNoConfig(ctx context.Context, params *rexTypes.CreateExistBucketNoConfigReq) (result *rexTypes.CreateExistBucketNoConfigResp, err error) {
