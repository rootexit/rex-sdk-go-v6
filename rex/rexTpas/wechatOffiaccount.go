...
type (
	WechatOffiaccountService interface {
		// note: 公众号code换token
		Code2Token(ctx context.Context, params *rexTypes.WechatOffiaccountCode2TokenReq) (code int32, result *rexTypes.WechatOffiaccountCode2TokenResp, err error)
		// note: 为某个公众号强制刷新凭证
		ForceRefreshOffiaccountAccessToken(ctx context.Context, params *rexTypes.WechatForceRefreshOffiaccountAccessTokenReq) (code int32, result *rexTypes.WechatForceRefreshOffiaccountAccessTokenResp, err error)
		// note: 获取公众号普通AccessToken
		GetAccessToken(ctx context.Context, params *rexTypes.WechatOffiaccountGetAccessTokenReq) (code int32, result *rexTypes.WechatOffiaccountGetAccessTokenResp, err error)
		// note: 获取公众号JsApiTicket
		GetJsApiTicket(ctx context.Context, params *rexTypes.WechatOffiaccountGetJsApiTicketReq) (code int32, result *rexTypes.WechatOffiaccountGetJsApiTicketResp, err error)
		// note: 生成重定向授权链接
		GenShareConfig(ctx context.Context, params *rexTypes.WechatOffiaccountGenShareConfigReq) (code int32, result *rexTypes.WechatOffiaccountGenShareConfigResp, err error)
		// note: 生成分享配置注入
		GenRedirectUrl(ctx context.Context, params *rexTypes.WechatOffiaccountGenRedirectUrlReq) (code int32, result *rexTypes.WechatOffiaccountGenRedirectUrlResp, err error)
	}
